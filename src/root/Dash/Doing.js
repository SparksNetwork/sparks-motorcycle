import {merge, just, combineArray} from 'most'
import {div} from '@motorcycle/dom'

import {isolate} from 'util'

import {Projects, Engagements, Organizers} from 'components/remote'
import {ProjectItem, ProjectForm, EngagementItem} from 'components/ui'
...
export default sources => {
  ...
  const welcome = Welcome({...sources,
    isVisible$: combineArray(
      (p,e) => p.length === 0 && e.length === 0, [projects$, engagements$]
    ),
  })
